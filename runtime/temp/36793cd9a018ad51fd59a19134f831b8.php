<?php /*a:2:{s:75:"E:\webwww\tp5.1-advanced\application\backend\view\auth\department_list.html";i:1542950120;s:59:"E:\webwww\tp5.1-advanced\application\backend\view\base.html";i:1542945489;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        var vueBox = new Vue({
            ...
            methods: {
                deleteDepartment:function(id){
                    var _self = this;
                    var postUrl = "<?php echo url('/api/auth/delete-department'); ?>";
                ...
                getDepartmentList: function () {
                    ...
                    $.ajax({
                        type:'post',
                        url: "<?php echo url('/api/auth/department-list'); ?>",
                        data: params,
                        dataType: 'json',
                        success: function(result) {
                            if (result.Code === '0') {
